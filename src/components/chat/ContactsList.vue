  ...
  try {
    ...
    if (ret !== null && typeof ret === 'object') {
      Object.entries(ret).forEach(([key, value]) => {
        tableData.value.push(value as User);
      });
    }
...
<template>
  <div>
    ...
    <div style="padding: 10px 10px;">
      ...
      <el-button type="primary" @click="search" style="width: 50px;margin-left: 10px;">搜索</el-button>
    </div>
    <!--  这是联系人的list    -->
    <el-table :data="tableData" stripe style="width: 100%" max-height="100%" height="100%" highlight-current-row
      loading="lazy" @current-change="handleCurrentChange">
